                        ...
                        <?php foreach ($feed as $feedItem): ?>
                            ...
                            <article class="post col-sm-12 col-xs-12">                                            
                                ...
                                <div class="post-bottom">
                                    <div class="post-likes likes-container">
                                        <i class="fa fa-lg fa-heart-o"></i>
                                        <span class="likes-count likes"><?php echo $feedItem->countLikes(); ?></span>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="#" class="btn btn-default button-dislike <?php echo ($currentUser->likesPost($feedItem->post_id)) ? "" : "display-none"; ?>" data-id="<?php echo $feedItem->post_id; ?>">
